...
class EnhBlock(nn.Module):
    def __init__(self, nf):
        ...
        self.layers = nn.Sequential(
            # Restormer_Encoder(inp_channels=3, out_channels=64, dim=64, num_blocks=[1, 1], heads=[8, 8, 8]),
            Restormer_Encoder(inp_channels=3, out_channels=16, dim=16, num_blocks=[3, 3], heads=[2, 2, 2])
            # Restormer_Decoder(inp_channels=64, out_channels=3, dim=64, num_blocks=[1, 1], heads=[8, 8, 8])
        )
...
class EnhBlock_rev(nn.Module):
    def __init__(self, nf):
        super(EnhBlock_rev, self).__init__()
        self.layers = nn.Sequential(
            # Restormer_Encoder(inp_channels=3, out_channels=64, dim=64, num_blocks=[1, 1], heads=[8, 8, 8]),
            Restormer_Decoder(inp_channels=16, out_channels=3, dim=16, num_blocks=[3, 3], heads=[2, 2, 2])
            # Restormer_Decoder(inp_channels=64, out_channels=3, dim=64, num_blocks=[1, 1], heads=[8, 8, 8])
        )
...
class InvComp(nn.Module):
    def __init__(self, M):
        ...
        self.operations.append(b)
        b = CouplingLayer3(self.in_nc // 12, 5)
        self.operations.append(b)
        b = CouplingLayer3(self.in_nc // 12, 5)
        self.operations.append(b)
        b = CouplingLayer3(self.in_nc // 12, 5)
        ...
        b = InvertibleConv1x1(self.in_nc)
        self.operations.append(b)
        b = CouplingLayer3(self.in_nc // 12, 3)
        self.operations.append(b)
        b = CouplingLayer3(self.in_nc // 12, 3)
        self.operations.append(b)
        b = CouplingLayer3(self.in_nc // 12, 3)
